...
the General Linear Model as the unifying framework for regression and single-factor
ANOVA (Part 3), to an applied integration lab and the Generalized Linear Model
(Part 5). see
[Syllabus overview]({{ '/syllabus/' | relative_url }}) for details.
